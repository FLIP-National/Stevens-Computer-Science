...
public class IDLList<E> {
	...
	// create data fields for IDLList<E>
	private Node<E> head;
	private Node<E> tail;
	private int size;
	...
	// add "elem" at position "index"(counting from wherever
	...
	// add (E elem) that adds elem at the head (i.e. it becomes the first element of
	// the list).
	...
	// append (E elem) that adds elem as the new last element of the list (i.e. at
	// the tail)
	...
	// return the object at position index from the head. Using the index
	...
	// remove and return the element at the index. Using the index for fast access.
