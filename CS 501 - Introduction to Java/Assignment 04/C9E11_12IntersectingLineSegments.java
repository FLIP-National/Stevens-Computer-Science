 ...
 * C9E11_12IntersectingLineSegments.java
...
public class C9E11_12IntersectingLineSegments {
	...
	public static void main(String[] args) {
		...
		while(repeat != 0)
		{
			...
			x1 = inputVar.nextDouble();
			System.out.print("Enter y1: ");
			y1 = inputVar.nextDouble();
			
			System.out.println("\nLine 1 : Second Endpoint");
			System.out.println("------------------------");
			System.out.print("Enter x2: ");
			x2 = inputVar.nextDouble();
			System.out.print("Enter y2: ");
			y2 = inputVar.nextDouble();
			
			System.out.println("\nLine 2 : First Endpoint");
			System.out.println("-----------------------");
			System.out.print("Enter x3: ");
			x3 = inputVar.nextDouble();
			System.out.print("Enter y3: ");
			y3 = inputVar.nextDouble();
			
			System.out.println("\nLine 2 : Second Endpoint");
			System.out.println("------------------------");
			System.out.print("Enter x4: ");
			x4 = inputVar.nextDouble();
			System.out.print("Enter y4: ");
			y4 = inputVar.nextDouble();
